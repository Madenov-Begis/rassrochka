import { ArrowLeft, Store, Users, CreditCard, AlertTriangle, Settings, BarChart3, MapPin, Phone } from "lucide-react"
...
export default function StoreDetailPage() {
  ...
  const updateStatusMutation = useMutation({
    mutationFn: (status: string) => adminApi.updateStoreStatus(id as string, status),
    onSuccess: () => {
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="payment_overdue">Просрочка платежа</SelectItem>
                  ...
                  {store.data?.status === "payment_overdue" && (
                    <Alert>
                      ...
                      <AlertDescription>
                        Магазин имеет просрочку по платежам. Рекомендуется связаться с руководством.
                      </AlertDescription>
                    </Alert>
                  )}
                  ...
                  <TableBody>
                    {store.data?.installments?.map((installment: Installment) => (
                      <TableRow key={installment.id}>
                        ...
                        <TableCell>{(Number(installment.totalAmount) || 0).toLocaleString('ru-RU', { maximumFractionDigits: 0 })} UZS</TableCell>
