...
export default function UserDetailPage() {
  ...
  const { data: user, isLoading } = useQuery<ApiResponse<AdminUser>>({
  ...
  const getRoleBadge = (role: 'admin' | 'store_manager' | '') => {
    const variants = {
            ...
            <DialogContent>
              ...
              <UserForm
                initialValues={{
                  ...
                  storeId: user?.data?.storeId.toString(),
                }}
