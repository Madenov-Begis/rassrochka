...
## Чёрный список
- Для предотвращения мошенничества реализован чёрный список клиентов.
- Магазин при создании рассрочки может проверить по паспорту, есть ли клиент в чёрном списке или с просрочками (без раскрытия деталей).
- Чёрный список реализован отдельной таблицей Blacklist, связанной с клиентом по паспортным данным.
